# -*- coding: utf-8 -*-
"""
Created on Wed Jun 30 18:32:11 2021
...
def randomizedPartition(A,l,h):
    r=random.randrange(l,h)     #choosing random index for partition
    A[l]=A[r]
    p=partition(A, l, h)
    return p
...
def quickSort(A,l,h):
    if l<h:
        pivot = randomizedPartition(A, l, h) #for pivot
